<?php
  ...
  include 'controller/func_login.php';
  ...
  if (isset($_POST['login'])) {
    ...
    $classLogin->loginUser($username,$password);
  }
?>
<!DOCTYPE html>
<html>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="admin/index2.html"><b>SEA</b> - To Do</a>
      </div><!-- /.login-logo -->
    ...
    <center><p>Copyright &copy; SEA - To Do - SEAMEO SEAMOLEC 2016</p></center>
    </div><!-- /.login-box -->
